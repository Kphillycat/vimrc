...
" {{{ Salesforce
 let g:apex_backup_folder="/Users/keith.williams/Documents/vimforce/backup"
 let g:apex_temp_folder="/Users/keith.williams/Documents/vimforce/tmp"
...
" Set virtual edit to let the cursor move anywhere
set virtualedit=all
"TODO: lookup
set showcmd
"TODO: Basically take the filetype
...
set ignorecase
" But if we do include a capital letter, make it case sensitive
set smartcase
" Move to the first search as we type
set incsearch
